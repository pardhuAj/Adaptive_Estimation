...
classdef KFENV < rl.env.MATLABEnvironment
    ...
    methods              
        ...
        function this = KFENV(inputs)
            ...
            ObservationInfo.Name = 'Measurement (each timestep) Delta (state1) Delta(state2) Delta(state3)';
            ObservationInfo.Description = 'y delta(x1) delta(x2) delta(x3)';
        ...
        function [Observation,Reward,IsDone,LoggedSignals] = step(this,Action)
            ...
            Observation = [this.y(this.steps);send.delta(1);send.delta(2);send.delta(3)]; % 4 by 1 vector
        ...
        function InitialObservation = reset(this)
            ...
            Observation = [-0.0669112995372736 ;1;1;1]; % 3 by 1 vector
