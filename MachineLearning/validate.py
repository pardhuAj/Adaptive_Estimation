...
# Define your model architecture (ensure this matches the saved model structure)
...
# Validation Function
def validate_model(dataset_path, model_path, num_samples=100, output_csv="test_validation.csv"):
    dataset = KalmanDataset(dataset_path)
...
if __name__ == "__main__":
    model_path = "/home/asalvi/code_workspace/RL_AdpEst/MachineLearning/kalman_nn.pth"  # Update path
    dataset_path = "/home/asalvi/code_workspace/RL_AdpEst/MachineLearning/kalman_dataset_validation.pkl"  # Update path
